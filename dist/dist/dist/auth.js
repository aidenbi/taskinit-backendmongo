...
function validateCookie(_x, _x2, _x3) {
  return _validateCookie.apply(this, arguments);
}
function _validateCookie() {
  _validateCookie = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res, next) {
    var cookies, userid, userinfo;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.prev = 2;
          userid = jwt.verify(cookies.session_id, process.env.TOKEN_SECRET)._id;
...
router.post('/register', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _registerValidation, error, nameExist, salt, hashPassword, user;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 18:
          res.send({
            msg: 'Congratulations, you have made an account!'
          });
          _context.next = 24;
          break;
        case 21:
...
router.post('/login', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var cookies, logincred, userid, userinfo, _loginValidation, error, user, validnewPass, validPass, token, salt1, hashPassword, salt, hashnewPassword;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 6:
          ...
          return _context3.abrupt("return", res.status(200).json(userinfo));
        case 8:
        ...
        case 17:
          _context3.next = 19;
          return bcrypt.compare(req.body.newpassword, user.password);
        case 19:
          validnewPass = _context3.sent;
          _context3.next = 22;
        ...
        case 22:
          ...
          salt1 = "$2a$10$".concat(process.env.REACT_APP_SALT_ONE);
          _context3.next = 28;
          return bcrypt.hash(req.body.password, salt1);
        case 28:
